  ...
  return (
    <section className="py-8">
      <div className="max-w-7xl mx-auto px-6">
        {/* Main Carousel */}
        <div className="relative h-[50vh] min-h-[400px] bg-gradient-to-br from-gray-100 to-gray-200 rounded-sm overflow-hidden mb-4 cursor-pointer group border-red-500">
